  ...
  UI: {
    FieldGroup #GeneralInformation : {
      Data: [
        ...
        ... // special syntax for referring to the "remaining values" of array-valued annotations.
        // advantage of this syntax is that you do not have to repeat the other table columns
      ]
    },
  }
);